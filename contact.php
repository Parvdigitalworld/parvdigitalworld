...
<div class="banner-about md-pt-50 tran5s wow fadeInUp"
	style="background: linear-gradient(90deg, #7B7B7B 0%, rgba(84, 81, 81, 0.73) 23.44%, rgba(27, 25, 25, 0.00) 100%), url('images/banner/banner-03.png') center center no-repeat;">
		...
		<div class="row d-flex align-items-center">
			<div class="col-lg-7">
				<div class="left-content md-mb-50">
					<div class="mb-20">
						<h5 class="h5 fw-700">Join our team to create the best digital business solutions.</h5>
					</div>
					<div class="mb-30">
						<p class="">Something different Ready to get started</p>
					</div>
					<div class=""><a href="#" class="custom-btn-one">Free Consulting <i
			...
			<div class="col-lg-5">
				<div class="right-content">
					...
					<div class="mb-20">
						<p class=""><i class="bi bi-geo-alt"></i> 3739 Balboa Street, San Francisco, CA 94121</p>
					</div>
					<div class="mb-20">
						<p class=""><i class="bi bi-telephone"></i> Email: hello@templatemr.com</p>
					</div>
					<div class="">
						<p class=""><i class="bi bi-envelope-open"></i> Phone: +88 016 5941 101</p>
					</div>
				</div>
			</div>
		</div>
